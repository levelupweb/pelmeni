      ...
      <div className="index-page">
          ...
          <div className="section-content flex-column-start">
            <div className="visuals-head visuals-1" id="scene-1">
              <div className="visual visual-custom-0 layer" data-depth="0.2">
                <Fade bottom>
                  <img src={require("./src/img/goroshek.png")} className="visual-1" alt="" />
                </Fade>
              </div>
              ...
              <div className="visual visual-custom-3 layer" data-depth="0.3">
                <Fade bottom>
                  <img src={require("./src/img/section-2-chapter-1.png")} className="visual-3" width="50%" alt=""/>
                </Fade>
              </div>
              <div className="visual visual-custom-4 layer" data-depth="0.4">
                <Fade top>
                  <img src={require("./src/img/section-2-chapter-1.png")} className="visual-4" width="50%" alt=""/>
                </Fade>
              </div>
            </div>
        ...
        <div className="ui inverted vertical segment section-2">
          <div className="visuals-head visuals-2" id="scene-2">
            <div className="visual visual-rotation layer" data-depth="0.4">
              <Fade bottom>
                <img src={require("./src/img/pelmeni-2-shadow.png")} className="visual-1" alt="" />
              </Fade>
            </div>
            <div className="visual visual-custom-1 layer" data-depth="0">
              <Fade bottom>
                <img src={require("./src/img/section-2-chapter-2.png")} className="visual-2" width="12%" alt="" />
              </Fade>
            </div>
                ...
                <div className="eight wide column">
                  <Fade bottom>
                    ...
                    <p className="lead small">
                      Мы производим полуфабрикаты исключительно из натуральных ингредиентов.{" "}
                      Наша компания никогда не использовала в производстве добавки и консерванты!
                    </p>
                    <h1 className="ui header inverted">
                      Вкус
                    </h1>
                    <p className="lead small">
                      Натуральность и качество продуктов используемых при производстве, обеспечивают{" "}
                      высочайшие вкусовые качества наших полуфабрикатов.
                    </p>
                  </Fade>
                </div>
        ...
        <div className="ui inverted vertical segment section-3">
          <div className="visuals-head desktop-only visuals-3" id="scene-3">
              <div className="visual visual-custom-1 layer" data-depth="0">
                <img src={require("./src/img/section-3-chapter-1.jpg")} className="visual-1" height="50%" alt="" />
              </div>
              <div className="visual visual-custom-5 layer" data-depth="0.5">
                <Fade bottom>
                  <img src={require("./src/img/background-main-chapter-8.png")} className="visual-3" width="30%" alt="" />
                </Fade>
              </div>
              <div className="visual visual-custom-3 layer" data-depth="0.1">
                <Fade bottom>
                  <img src={require("./src/img/section-3-chapter-3.png")} className="visual-4" width="30%" alt="" />
                </Fade>
              </div>
              <div className="visual visual-custom-6 layer" data-depth="0.1">
                <Fade bottom>
                  <img src={require("./src/img/background-main-chapter-8.png")} className="visual-5" width="35%" alt="" />
                </Fade>
              </div>
              <div className="visual visual-custom-4 layer" data-depth="0.2">
                <Fade bottom>
                  <img src={require("./src/img/background-main-chapter-6.png")} className="visual-6" width="35%" alt="" />
                </Fade>
              </div>
            </div>
          <div className="section-content">
        ...
        <div className="ui inverted vertical segment section-4">
            <div className="visuals-head visuals-4" id="scene-4">
              <div className="visual visual-custom-2 layer" data-depth="0">
                <Fade bottom>
                  <img src={require("./src/img/section-2-chapter-1.png")} className="visual-1" width="50%" alt="" />
                </Fade>
              </div>
              <div className="visual visual-custom-3 layer" data-depth="0">
                <Fade bottom>
                  <img src={require("./src/img/section-2-chapter-1.png")} className="visual-2" width="40%" alt="" />
                </Fade>
              </div>
              <div className="visual visual-custom-1 layer" data-depth="0.2">
                <Fade bottom>
                  <img src={require("./src/img/section-4-chapter-4.png")} className="visual-3" width="35%" alt="" />
                </Fade>
              </div>
              <div className="visual visual-custom-4 layer" data-depth="0.2">
                <Fade bottom>
                  <img src={require("./src/img/background-main-chapter-8.png")} className="visual-4" width="32%" alt="" />
                </Fade>
              </div>
            </div>
            <div className="section-content">
              <div className="ui middle aligned stackable grid container">
                <div className="row">
                  <div className="eight wide column">
                    ...
                    <p className="lead small">
                      Тесто из муки высшего сорта замешанное на свежем яйце, его эластичность и{" "}
                      вкусовые качества не оставят вас равнодушными.
                    </p>
                    </div>
                  <div className="eight wide right floated column">
                    <div className="images">
        ...
        <div className="ui inverted vertical segment section-5">
          <div className="visuals-head visuals-5" id="scene-5">
            <div className="visual visual-custom-2 layer" data-depth="0.1">
              <Fade bottom>
                <img src={require("./src/img/background-main-chapter-8.png")} className="visual-2" width="35%" alt="" />
              </Fade>
            </div>
            <div className="visual visual-custom-3 layer" data-depth="0.1">
              <Fade bottom>
                <img src={require("./src/img/background-main-chapter-8.png")} className="visual-3" width="35%" alt="" />
              </Fade>
            </div>
          </div>
            ...
            <div className="ui middle aligned stackable grid container">
              <div className="row">
                ...
                <div className="eight wide column">
                  ...
                  <p className="lead small">
                    Мы гордимся своей продукцией, ее едят наши внуки, дети и мы сами.{" "}
                    Это главная гарантия нашего качества.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="image-with-description">
              ...
              <div className="description">
                ...
                <p className="lead small" style={{ maxWidth: "650px" }}>
                  Закажите нашу продукцию онлайн, оформив заказ прямо на нашем сайте!
                </p>
        ...
        <div className="ui vertical segment with-rotated-head section-contact">
          <div className="visuals-head visuals-6" id="scene-6">
            ...
            <div className="visual visual-rotation layer" data-depth="0.4">
              <Fade bottom>
                <img src={require("./src/img/pelmeni-4.png")} className="visual-1" alt="" />
              </Fade>
            </div>
            <div className="visual visual-custom-1 layer" data-depth="0">
              <Fade bottom>
                <img src={require("./src/img/section-2-chapter-2.png")} className="visual-2" width="200px" alt="" />
              </Fade>
            </div>
            <div className="visual visual-custom-2 layer" data-depth="0.2">
              <Fade bottom>
                <img src={require("./src/img/section-2-chapter-1.png")} className="visual-3" width="700px" alt="" />
              </Fade>
            </div>
            <div className="visual visual-custom-2 layer" data-depth="0.2">
              <Fade bottom>
                <img src={require("./src/img/section-2-chapter-1.png")} className="visual-4" width="500px" alt=""/>
              </Fade>
            </div>
          </div>
          <div className="section-content">
